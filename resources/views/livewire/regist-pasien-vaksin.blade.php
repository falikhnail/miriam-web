<form class="w-full mt-[3rem]" wire:submit.prevent="store">
    ...
    <div class="flex flex-wrap mb-3">
        <div class="w-full md:px-3">
            ...
            <input class="main-input" id="vaksin" name="vaksin" type="text" wire:model="form.vaksin">
        </div>
    </div>
    <div class="flex flex-wrap mb-3">
        <div class="w-full md:px-3">
    ...
    <div class="flex flex-wrap mb-3">
        <div class="w-full md:px-3">
            ...
            <div class="relative" wire:target="form.schedule">
    ...
    <div class="flex flex-wrap mb-3 relative">
        <div class="w-full md:px-3">
            ...
            <select class="main-input" id="dokter" name="dokter" wire:model.live="form.dokter_id">
