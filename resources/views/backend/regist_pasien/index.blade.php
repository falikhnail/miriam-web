...
@section('content')
    <div class="flex flex-col justify-center">
        <x-section-header title="Registrasi Pasien" subtitle="Daftar Pasien Registrasi Pasien" />
        <div class="my-10 shadow-lg rounded px-6 py-5 bg-white">
            {{-- <livewire:backend.vaksin-table /> --}}
            <div class="flex flex-row">
                <div class="flex items-center space-x-3">
                    <a href="{{ route('backend.pasien.p.create') }}" class="btn btn-primary">Tambah</a>
...
@push('after-scripts')
    ...
    <script type="text/javascript">
        let table = $('#datatable').DataTable({
            ...
            ajax: {
                url: '{{ route('backend.pasien.p.list') }}',
                data: function(d) {
