            ...
            <div class="flex flex-wrap mb-3">
                <div class="w-full md:px-3">
                    ...
                    <input
                        ...
                        value="{{ old('nama-lengkap-anak') }}" required>
                ...
                <div class="w-full md:px-3">
                    ...
                    <div class="flex flex-row items-center justify-center">
                        <input type="text" name="tempat-lahir"
                            ...
                            value="{{ old('tempat-lahir') }}" required/>
            ...
            <div class="flex flex-wrap mb-3">
                <div class="w-full md:px-3">
                    ...
                    <input
                        ...
                        id="nik-anak" name="nik-anak" type="text">
                </div>
            </div>
            <div class="flex flex-wrap mb-3">
                <div class="w-full md:px-3">
                    ...
                    <input
                        class="appearance-none block w-full bg-white text-gray-700 border border-gray-200 rounded-xl py-3 px-2 leading-tight focus:outline-none focus:bg-white focus:shadow-md"
                        id="nama-orang-tua" name="nama-orang-tua" type="text">
                </div>
            </div>
            <div class="flex flex-wrap mb-3">
                <div class="w-full md:px-3">
            ...
            <div class="flex flex-wrap mb-1">
                <div class="w-full md:px-3">
                    ...
                    <input
                        ...
                        id="no-hp" name="no-hp" type="text" required>
                </div>
            </div>
